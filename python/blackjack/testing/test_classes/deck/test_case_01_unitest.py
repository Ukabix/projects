...
# test case 01:
# white box deck initialization
# environment: venv Python 3.7.3 64 bit, VSC debug mode, W10 x64
# input data: test_deck object, print() fnc
# expected result: ordered, unshuffled list of 52 cards, ordered by suits = ('Hearts', 'Diamonds', 'Spades', 'Clubs')
# and ranks = ('Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight', 'Nine', 'Ten', 'Jack', 'Queen', 'King', 'Ace')
#
test_deck = Deck()
print(test_deck)
