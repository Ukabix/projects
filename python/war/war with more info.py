...
while game_on:
    ...
    while at_war:
        ...
        if player_one_cards[-1].value > player_two_cards[-1].value:
            ...
            print(
                f"Player one card: {player_one_last_card} vs player two card: {player_two_last_card}. Player one has won this one.")
            at_war = False
            ...
            print(
                f"Player one card: {player_one_last_card} vs player two card: {player_two_last_card}. Player two has won this one.")
            at_war = False
        else:
            # at_war
            print(
                f"Player one card: {player_one_last_card} vs player two card: {player_two_last_card}.")
            print("WAAAGH!")
